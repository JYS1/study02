...
document.write("roundNum : " + roundNum, "<br>");   // 반올림
document.write("floorNum : " + floorNum, "<br>");   // 반내림
document.write("rndNum : " + rndNum, "<br>");       // 난수 0 ~ 1사이
document.write("<hr>");
...
greenArr.splice( 2, 1, "서초", "역삼"); // 특정위치를 대체할것을 넣을것이다 2번째 에서부터 1개만 삭제
console.log( greenArr );
...
document.write( str.substr(21,4), "<br>");  // (위치에서 , 갯수까지)
...
document.write( "sum() -> " + sum( number1, number2) , "<br>");
...
function totals() {
    var total = 0;
    for ( var i = 0; i < arguments.length; ++i ) {  // 인수가 arguments로 들어간다.
        total += arguments[ i ];
    }
    return total;
}
